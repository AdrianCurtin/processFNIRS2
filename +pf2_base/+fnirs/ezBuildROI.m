...
%	A well-defined ROI field will have a table with the names of each ROI in the rownames
...
%	fNIR.info=table(myOptodes,'VariableNames',{'Optode'},'RowNames',myROInames);

%	Weakly-defined ROIs can also be used
