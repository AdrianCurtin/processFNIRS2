    ...
    methods (Test)
        ...
        function testInvalidFuncErrors(testCase)
            ...
            testCase.verifyError(...
                ...
                'pf2_base:hierarchicalAverage:invalidFunction', ...
    ...
    methods (Test)
        function testNoInputErrors(testCase)
            ...
            testCase.verifyError(...
                ...
                'pf2_base:hierarchicalAverage:noInput', ...
        ...
        function testMissingHierarchyErrors(testCase)
            ...
            testCase.verifyError(...
                ...
                'pf2_base:hierarchicalAverage:noHierarchy', ...
        ...
        function testMismatchedDimensionsErrors(testCase)
            ...
            testCase.verifyError(...
                ...
                'pf2_base:hierarchicalAverage:dimensionMismatch', ...
