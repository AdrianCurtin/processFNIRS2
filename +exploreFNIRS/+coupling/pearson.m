...
%
% Reference:
%   Standard Pearson product-moment correlation. For its application in
%   fNIRS connectivity see: Scholkmann, F., Holper, L., Wolf, U. & Wolf,
%   M. (2013). A new methodical approach in neuroscience: assessing
%   inter-personal brain coupling using functional near-infrared imaging
%   (fNIRI) hyperscanning. Frontiers in Human Neuroscience, 7, 813.
