...
close(fig);
fprintf('  Saved bar chart with byGroup scheme (default)\n');
...
close(fig);
fprintf('  Saved temporal plot with byGroup scheme\n');
...
close(fig);
fprintf('  Saved bar chart with byCondition scheme (per-plot)\n');
...
close(fig);
fprintf('  Saved bar with explicit Colors override\n');
