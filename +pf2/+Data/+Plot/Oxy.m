...
% Oxy(fNIR,channels,showMarkers,bioMlist,baseline,ylimit,plotArranged,lineProps,rejectedLineProps)
...
for j=1:length(probes_index)
    ...
    figHandle(j) = OxyHelper(fNIR_i, plotChannels, showMarkers, bioMlist, baseline, ylimit, plotArranged, lineProps, rejectedLineProps);
end

    function [ figHandle ] = OxyHelper(fNIR,channels,showMarkers,bioMlist,baseline,ylimit,plotArranged,lineProps,rejectedLineProps)
        %pf2.Data.Plot.Oxy
