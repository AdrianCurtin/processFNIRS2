...
% HITACHI_ETG4000_3X5 Load the bundled Hitachi ETG-4000 3x5 sample recording
%
% Loads a Hitachi ETG-4000 optical topography sample recording acquired with
% a 3x5 probe array (44 raw channels), bundled with the toolbox. Useful for
% demonstrating the Hitachi MES import path and probe-specific layouts.
%
% Syntax:
...
%
% Example:
%   % Import and process a Hitachi 3x5 recording
%   data = pf2.import.sampleData.Hitachi_ETG4000_3x5();
%   processed = processFNIRS2(data);
%
% See also: pf2.import.sampleData, pf2.import.sampleData.Hitachi_ETG4000_3x11,
