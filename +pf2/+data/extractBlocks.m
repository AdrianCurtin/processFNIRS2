function segments = extractBlocks(data, blocks, varargin)
...
%   'PreTime'        - Seconds to include before block start (default: 0)
%   'PostTime'       - Seconds to include after block end (default: 0)
...
%   'CopyInfo'       - Copy parent data.info into each segment (default: true)
