...
Baseline_730 = nanmean (w730(bs:be,:));
Baseline_805 = nanmean (w805(bs:be,:));
Baseline_850 = nanmean (w850(bs:be,:));
...
OD_850 = - log10 (w850(ss:se,:)./Baseline_850);
      ...
      eHBR_730=0.11022;       % Coefficients in 1/(mm*mM)
      eHBO_730=0.0390;      %  
      eHBR_805=0.073708;      %   saturation coefficients
      eHBO_805=0.0836;      %
      eHBR_850=0.069132;      %
      eHBO_850=0.1058;      %
 ...
 HBR=(OD_850*eHBO_730-OD_730*eHBO_850)/(eHBO_730*eHBR_850-eHBO_850*eHBR_730);
  
      %HBR is the variation of the concentration in oxyhemoglobin
            
 HBO=(OD_730*eHBR_850-OD_850*eHBR_730)/(eHBO_730*eHBR_850-eHBO_850*eHBR_730);
      
      
      
 bv=(HBO+HBR);                             % Blood Volume                             
 bv805=OD_805/(eHBR_805+eHBO_805);   % Blood Volume directly from the wavelength 805
 oxy=(HBO-HBR);
