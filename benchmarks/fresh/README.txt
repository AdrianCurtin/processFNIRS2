...
2. Extract into benchmarks/data/:
...
Dataset II (Motor, simpler - start here):
   ...
   >> run('benchmarks/fresh/runDatasetII.m')

Dataset I (Auditory, group-level):

   >> run('benchmarks/fresh/runDatasetI.m')

Analyze and compare results:

   >> run('benchmarks/fresh/analyzeResults.m')
